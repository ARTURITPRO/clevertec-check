...
public class OrderProcessingServiceImplTest {
    ...
    void initDataExpectedCustomShoppingMap() {
        ...
        orderProcessingService = new OrderProcessingServiceImpl(connectionManagerTest, productValidation,
                discountCardValidation, productService, data, discountCardService);
    ...
    void orderProcessingCheckHashMapProduct() {
        ...
        when(discountCardService.findByNumber(connectionManagerTest, 11111)).thenReturn(Optional.of(DiscountCard.builder().id(1).name("mastercard").discount(10).number(11111).build()));
